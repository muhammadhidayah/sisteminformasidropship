			...
			<div class="col-lg-12">
				<div class="panel panel-default">
					...
					<div class="panel-body">
						...
						<table data-toggle="table" id="data_transaksi" data-url="<?php echo site_url('dropshipper/ShowTransaksi');?>" data-show-refresh="true" data-show-toggle="false" data-show-columns="true" data-search="false" data-select-item-name="toolbar1" data-pagination="true" data-sort-name="name" data-sort-order="desc">
						    <thead>
						    <tr>
						        <th data-field="id_purchase" data-sortable="true"><center>ID Purchase</center></th>
						        <th data-field="nama_toko" data-sortable="true"><center>Nama Toko</center></th>
						        <th data-field="status" data-sortable="true"><center>Status</center></th>
						        <th data-field="option" data-sortable="true"><center>option</center></th>
						    </tr>
						    </thead>
						</table>
					</div>
...
<script type="text/javascript">
	$(function() {
		...
		$('#data_transaksi').on('click','.btn-lihat-detail', function() {
			...
			$.ajax({
				url: '<?php echo site_url('dropshipper/getDetailTransaksi'); ?>',
				data: {id: id},
				dataType: 'json',
				method: 'POST',
				async: false,
