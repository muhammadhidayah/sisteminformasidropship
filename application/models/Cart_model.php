...
class Cart_model extends CI_Model {
	...
	public function order() {
		$alamat = "#Penerima: ". $this->input->post('txtNama') . "#Alamat " .$this->input->post('txtAlamat'). ' ' .$this->input->post('txtProvinsi'). ' ' .$this->input->post('txtKabupaten'). ' ' .$this->input->post('txtKecamatan'). ' NoHp' .$this->input->post('txtNohp');
